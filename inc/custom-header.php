...
function cinnamon_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'cinnamon_custom_header_args', array(
		...
		'admin-head-callback'    => 'cinnamon_admin_header_style',
		'admin-preview-callback' => 'cinnamon_admin_header_image',
	) ) );
}
...
if ( ! function_exists( 'cinnamon_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see cinnamon_custom_header_setup().
 */
function cinnamon_admin_header_style() {
?>
	<style type="text/css">
...
endif; // cinnamon_admin_header_style

if ( ! function_exists( 'cinnamon_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see cinnamon_custom_header_setup().
 */
function cinnamon_admin_header_image() {
...
endif; // cinnamon_admin_header_image